        ...
        var d = {
                ...
                setTimeout(function () {
                    ...
                    n = document.querySelector(
                        ...
                        ? document.querySelector(
                              ".layout-navbar-full .layout-navbar > div"
                          )
                        : document.querySelector(
            ...
            setStoredTheme: function (e, t) {
                localStorage.setItem(
                    "templateCustomizer-".concat(e, "--Theme"),
                    t
                );
            },
            ...
            syncThemeToggles: function (e) {
                document
                    .querySelectorAll("[data-bs-theme-value]")
                    .forEach(function (t) {
                        t.getAttribute("data-bs-theme-value") === e &&
                            t.click();
                    });
            },
            syncCustomOptions: function (e) {
                var t = document.querySelector(
                    '.template-customizer-themes-options input[value="'.concat(
                        e,
                        '"]'
                    )
                );
            ...
            getCssVar: function (e) {
                return !0 ===
                    ...
                    ? getComputedStyle(document.documentElement)
                          .getPropertyValue(
                              "--".concat(window.Helpers.prefix).concat(e)
                          )
                          .trim()
